...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--librispeech_root", type=str, required=True, help="Root folder of LibriSpeech")
    parser.add_argument("--demand_root", type=str, required=True, help="Root folder of DEMAND noise")
